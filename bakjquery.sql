...
/****** Object:  Table [dbo].[PW_Buzon_Sugerencias]    Script Date: 09/02/2021 14:53:16 ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
-- alter table PW_Buzon_Sugerencias
 -- add flagdatos bit not null ;
 --  alter table PW_Buzon_Sugerencias
 -- add flagley bit not null ;
